...
public abstract class BaseActivityInstrumentationTestCase<T extends Activity> extends
	...
	protected void tearDown() throws Exception {
		...
		SharedPreferences preferences = PreferenceManager.getDefaultSharedPreferences(this.getInstrumentation().getContext());
		...
		if (paths == null) {
			...
			try {
				...
				for (String projectName : UtilFile.getProjectNames(rootDirectory)) {
					...
					ProjectManager.getInstance().deleteProject(projectName, this.getInstrumentation().getContext());
				}
